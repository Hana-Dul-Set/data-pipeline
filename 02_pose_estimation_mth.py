'''
1. pct/env2/Scripts/activate
2. cd pct
3. python ../02_pose_estimation.py
'''
...
def run_slice(offset):
    for i in range(offset, len(slice_idxs), num_workers):
...
if __name__ == '__main__':
    ...
    for i in range(num_workers):
        processes.append(Process(target=run_slice, args=(i,)))
        processes[i].start()
